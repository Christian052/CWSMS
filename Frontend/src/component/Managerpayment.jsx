      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8">
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto rounded-lg shadow-lg">
            <table className="w-full text-sm text-left text-gray-700 bg-white dark:bg-gray-800 dark:text-white">
                ...
                {payments.length > 0 ? (
                  payments.map((payment, index) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-3 sm:px-4 sm:py-3 hidden md:table-cell ">{payment.RecordNumber}</td>
